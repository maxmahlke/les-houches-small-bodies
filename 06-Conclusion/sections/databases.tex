...
\begin{frame}
  ...
  \begin{columns}[T]
      ...
      \begin{column}{.3\textwidth}
        \only<1>{%
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_cds}\\
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_pds}\\
          % \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_mp3c}\\
          % \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_ssodnet}\\
        }%
        \only<2->{%
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{data_dir}\\
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_astorb}\\
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_mp3c}\\
          \vspace{0.5em}\includegraphics[width=.8\textwidth]{logo_ssodnet}\\
        }%
      \end{column}
